...
$messages['fr'] = array(
	'header-title' => "Wikimania 2012 - Demande de bourse",
	'page-header' => "Demande de bourse pour assister à Wikimania 2012",
	'text-intro' => "
	<p>Ceci est la page pour demander une bourse pour assister à <a href='http://wikimania2012.wikimedia.org'>Wikimania 2012</a>, la conférence internationale annuelle de Wikimédia.
	...
	'form-telephone' => "Numéro de téléphone (avec le code international) :",
	'form-mailing-address' => "Adresse postale :",
	'form-country-residence' => "Pays de résidence :",
	'form-haspassport' => "Avez-vous un passeport valide ? (O/N)",
	'form-yes' => "Oui",
	'form-no' => "Non",
	...
	'form-gender-unspecified' => "Non communiqué",
	...
	'form-primary-project' => "Projet Wikimédia primaire (Wikipédia, Wikimédia Commons, etc.): ",
	'form-lang-version' => "Quelle(s) version(s) localisée(s) des projets Wikimédia utilisez vous le plus?  ",
	...
	'form-future-explain' => "Dans l'espace suivant, expliquez comment et pourquoi assister à Wikimania changera la nature de votre engagement future dans le nouvement Wikimedia.",
	'form-partial' => "Bourses complémentaires",
	'form-partial-explain' => "En complément aux bourses complètes, un nombre limité de <b>bourses complémentaires</b> est aussi disponible pour subventionner à hauteur de 300 USD les frais de transport.",
	...
	'form-review' => "Toutes les informations contenues dans cette demande vont être étudiées par les membres du Comité du programme des bourses de Wikimania. Toutes les informations personnelles seront gardées strictement confidentielles par le Comité et la Foundation Wikimédia.",
	'form-submit-app' => "Envoyer la demande",
	'form-email-subject' => "Demande de bourse pour Wikimania 2012",
	'form-email-response' =>
	"Cher / Chère $1,

	Nous vous confirmons la réception de vôtre demande de bourse pour voyager et assister à Wikimania 2012.
	Nous vous ferons parvenir nôtre réponse à vôtre demande après avoir étudié et évalué toutes les demandes.
	...
	* Courriel: $4
	...
	Veuillez contacter wikimania-scholarships@wikimedia.org pour toute question relative à vôtre demande de bourse.
