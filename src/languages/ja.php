...
$messages['ja'] = array(
	'header-title' => "ウィキマニア2012 - 参加費用補助申請",
	'page-header' => "ウィキマニア2012参加費用補助申請",
	'text-intro' => "
	<p>こちらはウィキメディアの国際会議「<a href='http://wikimania2012.wikimedia.org'>ウィキマニア2012</a>」への参加費用補助の申請です。2012年7月12日から15日までアメリカ合衆国ワシントンD.C.において開催されるウィキマニアへの参加費、宿泊費および交通費が選考の上支給されます。</p>
	<p>これは、大学で勉強をするための奨学金では<strong>ありません</strong>。明らかにウィキマニアに関連しない申請は却下されます。</p>
	<p>申請される方へ：本当に財政的支援が必要かどうかをよく検討してください。ウィキマニア参加のための補助に支出できる資金は限られており、かつ補助なしではウィキマニアに参加することのできない方々が大勢いらっしゃいます。ありがとうございます。</p>
	<p>申請期限は<strong>2012年2月16日</strong>です。</p>",
	'form-error' => '入力内容に誤りがあります。誤りを修正し再度送信してください。',
	'contact-info' => "連絡先情報",
	'name-first' => "名（ファーストネーム）：",
	'name-last' => "姓（ラストネーム）",
	'form-email' => "メールアドレス",
	...
	'form-passport-explain' => "（ビザが必要な場合、その申請の補助に使用します）",
	...
	'form-gender-unspecified' => "いずれにも該当しない",
	...
	'form-prior-recipient' => "以前にウィキマニアへの渡航補助・参加費用の補助を受け取ったことがあります。",
	...
	'form-lang-version' => "ウィキメディアのどの言語版を最もよく使用しますか？（複数可）",
	...
	'form-future-explain' => "下の入力欄で、ウィキマニアへ参加することであなたの今後のウィキメディア運動への関わり方がどのようになぜ変わるのかを説明してください。",
	'form-partial' => "参加費用の一部補助",
	'form-partial-explain' => "参加費用の全額補助に加えて、今年は交通費の上限が300ユーロ（およそ380米ドル、3万円）の<b>一部補助</b>も選択可能です。",
	...
	これはウィキマニア2012参加費用補助申請の確認メールです。

	あなたの参加費用補助に関する決定は、全ての申請の確認と点数付けが終了し次第通知します。

	不明な点がある場合は、wikimania-scholarships@wikimedia.org までご連絡ください。

	ウィキマニア 参加費用補助チーム",
	'confirm-thanks' => "ありがとうございました！",
	'confirm-text' =>
	"ウィキマニア2012参加費用補助申請にお申し込みいただきありがとうございました。不明な点がございましたら<a href='mailto:wikimania-scholarships@wikimedia.org'>wikimania-scholarships@wikimedia.org</a>までご連絡ください。",
	'confirm-faq' => "<a href='http://wikimania2012.wikimedia.org/wiki/Scholarships/FAQ' target='_blank'>よくある質問と回答</a>",
	'text-have-submitted-presentation' => "ウィキマニア2012での発表を送信しました（<a href='http://wikimania2012.wikimedia.org/wiki/Call_for_Participation' target='_blank'>発表申し込み</a>）",
	'email-confirm-subject' => "ウィキマニア2012参加費用補助申請",
	'email-confirm-text' =>
	"これはウィキマニア2012参加費用補助申請の確認メールです。
	...
	'email-from' => "ウィキマニア2012参加費用補助申請",
	'scholarship-decision' => "ウィキマニア2012参加費用補助に関する決定",
	'new-account-subject' => "ウィキマニア参加費用補助の新しいアカウント",
	'new-account-email' => "ウィキマニア参加費用補助の新しいアカウントが作成されました。
	...
	パスワードは https://secure.wikidc.org/wm/schols/review/user_pwreset.php で変更することができます。
	...
	<p>コードはウィキマニア2009、2010、2011に使用された参加費用補助申請システムを基本に、ウィキマニア2012用に修正されたものです。</p>",
	'help-translate' => "翻訳する",
	'translate-page' => "<p>参加費用補助申請システムの多くの言語への翻訳を歓迎します。</p>

	<p>コードと言語ファイルは<a href='http://github.com/filbertkm/Scholarships'>github</a>にあります。そこで翻訳を送信してください。</p>
